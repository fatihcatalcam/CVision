...
SKILLS_DATA: list[dict[str, str]] = [
    ...
    # ---- Media ----
    {"name": "Adobe Premiere", "category": "media"},
    {"name": "Final Cut Pro", "category": "media"},
    {"name": "DaVinci Resolve", "category": "media"},
    {"name": "Avid Media Composer", "category": "media"},
    {"name": "After Effects", "category": "media"},
    {"name": "Adobe Audition", "category": "media"},
    {"name": "Pro Tools", "category": "media"},
    {"name": "Cinema 4D", "category": "media"},
    {"name": "Blender", "category": "media"},
    {"name": "Color Grading", "category": "media"},
    {"name": "Video Editing", "category": "media"},
    {"name": "Motion Graphics", "category": "media"},
    {"name": "Storyboarding", "category": "media"},
    {"name": "Cinematography", "category": "media"},
    {"name": "Sound Design", "category": "media"},
    {"name": "Audio Mixing", "category": "media"},
    {"name": "Screenwriting", "category": "media"},
    {"name": "Lighting Design", "category": "media"},
    {"name": "Camera Operation", "category": "media"},
    {"name": "Post-Production", "category": "media"},
    {"name": "Adobe Lightroom", "category": "media"},
    {"name": "Photo Retouching", "category": "media"},
    {"name": "Studio Photography", "category": "media"},
    {"name": "Drone Operation", "category": "media"},
    {"name": "Live Streaming", "category": "media"},
    {"name": "OBS Studio", "category": "media"},
    {"name": "3D Animation", "category": "media"},
    {"name": "Character Rigging", "category": "media"},
    {"name": "Visual Effects", "category": "media"},

    # ---- Journalism ----
    {"name": "News Writing", "category": "journalism"},
    {"name": "AP Style", "category": "journalism"},
    {"name": "Interviewing", "category": "journalism"},
    {"name": "Fact-Checking", "category": "journalism"},
    {"name": "Investigative Reporting", "category": "journalism"},
    {"name": "Editorial Judgment", "category": "journalism"},
    {"name": "Copy Editing", "category": "journalism"},
    {"name": "Headline Writing", "category": "journalism"},
    {"name": "Broadcast Journalism", "category": "journalism"},
    {"name": "Newsroom CMS", "category": "journalism"},
    {"name": "Press Release", "category": "journalism"},
    {"name": "Media Relations", "category": "journalism"},
    {"name": "Feature Writing", "category": "journalism"},
    {"name": "Radio Production", "category": "journalism"},
    {"name": "Podcast Production", "category": "journalism"},
    {"name": "Teleprompter", "category": "journalism"},

    # ---- Legal ----
    {"name": "Contract Law", "category": "legal"},
    {"name": "Litigation", "category": "legal"},
    {"name": "Legal Research", "category": "legal"},
    {"name": "Legal Drafting", "category": "legal"},
    ...
    {"name": "Pedagogy", "category": "education"},
    {"name": "Learning Management System", "category": "education"},
    {"name": "Moodle", "category": "education"},
    {"name": "Instructional Design", "category": "education"},
    {"name": "SCORM", "category": "education"},
    {"name": "Articulate Storyline", "category": "education"},
    {"name": "Assessment Design", "category": "education"},
    {"name": "Differentiated Instruction", "category": "education"},
    ...
    {"name": "Academic Writing", "category": "education"},
    {"name": "Literature Review", "category": "education"},
    {"name": "Research Methodology", "category": "education"},
    {"name": "Grant Writing", "category": "education"},
    {"name": "Peer Review", "category": "education"},
    {"name": "Thesis Supervision", "category": "education"},

    # ---- Clinical ----
    {"name": "Patient Care", "category": "clinical"},
    {"name": "Clinical Documentation", "category": "clinical"},
    {"name": "Triage", "category": "clinical"},
    {"name": "Vital Signs Monitoring", "category": "clinical"},
    {"name": "Medication Administration", "category": "clinical"},
    {"name": "IV Therapy", "category": "clinical"},
    {"name": "Wound Care", "category": "clinical"},
    {"name": "Infection Control", "category": "clinical"},
    {"name": "Hospital Information System", "category": "clinical"},
    {"name": "Electronic Health Records", "category": "clinical"},
    {"name": "ICD Coding", "category": "clinical"},
    {"name": "Phlebotomy", "category": "clinical"},
    {"name": "CPR Certification", "category": "clinical"},
    {"name": "Basic Life Support", "category": "clinical"},
    {"name": "Advanced Cardiac Life Support", "category": "clinical"},
    {"name": "Pharmacology", "category": "clinical"},
    {"name": "Prescription Review", "category": "clinical"},
    {"name": "Physical Therapy", "category": "clinical"},
    {"name": "Rehabilitation", "category": "clinical"},
    {"name": "Manual Therapy", "category": "clinical"},
    {"name": "Nutrition Assessment", "category": "clinical"},
    {"name": "Diet Planning", "category": "clinical"},
    {"name": "Laboratory Testing", "category": "clinical"},
    {"name": "Sample Analysis", "category": "clinical"},
    {"name": "Radiology", "category": "clinical"},
    {"name": "Surgical Assistance", "category": "clinical"},
    {"name": "Patient Education", "category": "clinical"},
    ...
    {"name": "Customer Retention", "category": "sales"},
    {"name": "Churn Analysis", "category": "sales"},
    {"name": "Customer Onboarding", "category": "sales"},
    {"name": "Quota Attainment", "category": "sales"},
    {"name": "Proposal Writing", "category": "sales"},
    {"name": "Tender Management", "category": "sales"},
    {"name": "Technical Sales", "category": "sales"},

    # ---- Hospitality ----
    {"name": "Opera PMS", "category": "hospitality"},
    {"name": "Front Office Operations", "category": "hospitality"},
    {"name": "Reservation Management", "category": "hospitality"},
    {"name": "Guest Relations", "category": "hospitality"},
    {"name": "Housekeeping Management", "category": "hospitality"},
    {"name": "Revenue Management", "category": "hospitality"},
    ...
    {"name": "Menu Planning", "category": "hospitality"},
    {"name": "Kitchen Management", "category": "hospitality"},
    {"name": "Culinary Arts", "category": "hospitality"},
    {"name": "Cost Control", "category": "hospitality"},
    {"name": "Banquet Operations", "category": "hospitality"},
    {"name": "Event Coordination", "category": "hospitality"},
    {"name": "Tour Planning", "category": "hospitality"},
    {"name": "Amadeus", "category": "hospitality"},
    {"name": "Galileo", "category": "hospitality"},
    {"name": "Hospitality Sales", "category": "hospitality"},
    {"name": "Sommelier", "category": "hospitality"},

    # ---- Design ----
    {"name": "SketchUp", "category": "design"},
    {"name": "3ds Max", "category": "design"},
    {"name": "Rhino", "category": "design"},
    {"name": "Lumion", "category": "design"},
    {"name": "V-Ray", "category": "design"},
    {"name": "ArchiCAD", "category": "design"},
    {"name": "Adobe InDesign", "category": "design"},
    {"name": "Adobe Illustrator", "category": "design"},
    {"name": "Adobe Photoshop", "category": "design"},
    {"name": "CorelDRAW", "category": "design"},
    {"name": "Architectural Drafting", "category": "design"},
    {"name": "Space Planning", "category": "design"},
    {"name": "Interior Rendering", "category": "design"},
    {"name": "Building Codes", "category": "design"},
    {"name": "Construction Documentation", "category": "design"},
    {"name": "Landscape Design", "category": "design"},
    ...
    {"name": "Packaging Design", "category": "design"},
    {"name": "Industrial Design", "category": "design"},
    {"name": "Rapid Prototyping", "category": "design"},

    # ---- Trades ----
    {"name": "PLC Programming", "category": "trades"},
    {"name": "SCADA", "category": "trades"},
    {"name": "Electrical Wiring", "category": "trades"},
    {"name": "Panel Building", "category": "trades"},
    {"name": "Preventive Maintenance", "category": "trades"},
    {"name": "Troubleshooting", "category": "trades"},
    {"name": "Hydraulics", "category": "trades"},
    {"name": "Pneumatics", "category": "trades"},
    {"name": "Welding", "category": "trades"},
    {"name": "TIG Welding", "category": "trades"},
    {"name": "MIG Welding", "category": "trades"},
    {"name": "Blueprint Reading", "category": "trades"},
    {"name": "CNC Machining", "category": "trades"},
    {"name": "CNC Programming", "category": "trades"},
    {"name": "Lathe Operation", "category": "trades"},
    {"name": "Milling", "category": "trades"},
    {"name": "Metrology", "category": "trades"},
    {"name": "Calibration", "category": "trades"},
    {"name": "Automotive Diagnostics", "category": "trades"},
    {"name": "Engine Repair", "category": "trades"},
    {"name": "Forklift Operation", "category": "trades"},
    {"name": "Occupational Safety", "category": "trades"},
    {"name": "Lockout Tagout", "category": "trades"},

    # ---- Public ----
    {"name": "Policy Analysis", "category": "public"},
    {"name": "Public Administration", "category": "public"},
    {"name": "Grant Management", "category": "public"},
    {"name": "Monitoring and Evaluation", "category": "public"},
    {"name": "Public Procurement", "category": "public"},
    {"name": "Stakeholder Engagement", "category": "public"},
    {"name": "Program Coordination", "category": "public"},
    {"name": "Community Outreach", "category": "public"},
    {"name": "Donor Reporting", "category": "public"},
    {"name": "Logical Framework", "category": "public"},
    {"name": "Advocacy", "category": "public"},
    {"name": "Fundraising", "category": "public"},
    {"name": "Volunteer Management", "category": "public"},
    {"name": "Crisis Communication", "category": "public"},
    {"name": "Public Relations", "category": "public"},
    {"name": "Media Monitoring", "category": "public"},

    # ---- Caught by the taxonomy lint test: referenced by roles above ----
