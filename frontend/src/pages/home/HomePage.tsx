...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#FBFBFA]">
      ...
      {/* Nav */}
      <header className="sticky top-0 z-50 bg-[#FBFBFA]/95 backdrop-blur-sm border-b border-[#EAEAEA]">
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          <span className="font-serif text-lg tracking-tight text-[#111111]">CVision</span>
      ...
      <section className="max-w-5xl mx-auto px-6 pt-24 pb-20">
        <div className="max-w-3xl">
          ...
          <p className="text-lg text-[#787774] leading-relaxed mb-10 max-w-xl">
      ...
      <section id="how-it-works" className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            ...
            <div key={n}>
              <span className="stat-number text-4xl font-medium text-[#EAEAEA] block mb-4">{n}</span>
              <h3 className="text-base font-semibold text-[#111111] mb-2">{title}</h3>
              <p className="text-sm text-[#787774] leading-relaxed">{desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="features" className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="surface p-8 md:row-span-2">
            <div className="w-8 h-8 bg-[#EEF2F8] rounded-[var(--radius-md)] flex items-center justify-center mb-6">
              <Brain className="w-4 h-4 text-[#1B3A6B]" strokeWidth={1.5} />
            </div>
            <h3 className="font-serif text-2xl tracking-tight mb-3">Intelligent scoring</h3>
          ...
          <div className="surface p-6">
            <div className="w-8 h-8 bg-[#EDF3EC] rounded-[var(--radius-md)] flex items-center justify-center mb-4">
              <BarChart3 className="w-4 h-4 text-[#346538]" strokeWidth={1.5} />
            </div>
            <h3 className="font-semibold text-[#111111] mb-2">Career matching</h3>
            <p className="text-sm text-[#787774]">See which roles your CV fits today, and which skills would unlock new ones.</p>
          </div>
          <div className="surface p-6">
            <div className="w-8 h-8 bg-[#FBF3DB] rounded-[var(--radius-md)] flex items-center justify-center mb-4">
              <FileText className="w-4 h-4 text-[#956400]" strokeWidth={1.5} />
            </div>
            <h3 className="font-semibold text-[#111111] mb-2">Skill extraction</h3>
            <p className="text-sm text-[#787774]">Skills automatically detected, tagged by confidence, pulled directly from your CV text.</p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-3 divide-x divide-[#EAEAEA]">
          {[
            ...
            <div key={label} className="px-8 first:pl-0 last:pr-0">
              <span className="stat-number text-3xl font-semibold text-[#111111] block mb-1">{value}</span>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div>
          <h2 className="font-serif text-3xl tracking-tight text-[#111111] mb-2">
            Ready to improve your CV?
          </h2>
          <p className="text-sm text-[#787774]">Free to start. No credit card required.</p>
        </div>
        {!isLoading && (isAuthenticated ? (
          <Button size="lg" onClick={() => navigate('/dashboard')}>
            Go to Dashboard
      ...
      <footer className="border-t border-[#EAEAEA] bg-white">
        <div className="max-w-5xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="font-serif text-base text-[#111111]">CVision</span>
