      ...
      <div className="flex justify-between items-center mb-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-[#6B6A65] hover:text-[#111111] dark:hover:text-[#e8e7e4] bg-white dark:bg-[#1c1c1a] hover:bg-[#F7F6F3] dark:hover:bg-[#272725] border border-[#8A8985] dark:border-white/[0.36] transition-all text-xs font-medium"
          >
