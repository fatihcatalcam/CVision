...
const variants: Record<ButtonVariant, string> = {
  ...
  secondary: 'bg-white dark:bg-[#1c1c1a] text-[#111111] dark:text-[#e8e7e4] border border-[#8A8985] dark:border-white/[0.36] hover:bg-[#F7F6F3] dark:hover:bg-white/[0.05] hover:shadow-sm active:scale-[0.98]',
