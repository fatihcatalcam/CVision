  ...
  const BENEFITS = [
    {
      ...
      title: t('emptyState.benefit1Title'),
      desc: t('emptyState.benefit1Desc'),
      bg: 'bg-[#EDF3EC] dark:bg-[#346538]/20',
      color: 'text-[#346538] dark:text-[#4ade80]',
    },
    {
      icon: <Target className="w-4 h-4" />,
      title: t('emptyState.benefit2Title'),
      desc: t('emptyState.benefit2Desc'),
      bg: 'bg-[#EEF2F8] dark:bg-[#1B3A6B]/20',
      color: 'text-[#1B3A6B] dark:text-[#4a7dd1]',
    },
    {
      icon: <Lightbulb className="w-4 h-4" />,
      title: t('emptyState.benefit3Title'),
      desc: t('emptyState.benefit3Desc'),
