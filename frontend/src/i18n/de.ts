const de = {
  ...
  settings: {
    analysesDone: 'Durchgeführte Analysen',
    credits: {
      title: 'Credits',
  ...
  imagePdf: {
    ...
    body: 'Die Datei wurde als Bild gespeichert. Wenn wir sie nicht lesen können, kann es das ATS des Unternehmens auch nicht; dein Lebenslauf kommt dort als leere Seite an.',
    fixesTitle: 'So behebst du das',
    fixWord: 'In Word oder Google Docs: Datei → Herunterladen → PDF.',
    fixCanva: 'In Canva: als „PDF Standard“ herunterladen und „PDF abflachen“ (Flatten PDF) nicht anhaken.',
    fixPhoto: 'Du hast nur ein Foto oder einen Scan? Lade die Datei in Google Drive hoch, Rechtsklick → Öffnen mit → Google Docs. Sie wird in Text umgewandelt; prüfe ihn und lade ihn als PDF herunter.',
    check: 'Teste es selbst: Öffne die PDF und drücke Strg+A (Cmd+A auf dem Mac). Wird der Text nicht markiert, kann ein ATS ihn nicht lesen.',
    uploadOther: 'Andere Datei hochladen',
    signupHint: 'Sobald du eine textbasierte PDF hast, erstelle ein kostenloses Konto; dein erster vollständiger Bericht geht auf uns.',
    signupCta: 'Kostenloses Konto erstellen',
    refunded: 'Die Credits für diesen Upload wurden dir erstattet.',
  },
  ...
  legal: {
    ...
    terms: {
      ...
      s6Heading: '6. Preise und Credits',
      s6Body1: 'CVision läuft über Credits; es gibt kein wiederkehrendes Abonnement. Jedes neue Konto erhält kostenlose Credits, und solange das Guthaben unter einer festgelegten Grenze bleibt, kommen wöchentlich weitere hinzu. Aktionen wie eine Analyse, ein Stellenabgleich oder ein erzeugtes Anschreiben ziehen Credits von deinem Guthaben ab; die aktuellen Kosten stehen auf der Preisseite.',
      s6Body2: 'Zusätzliche Credits werden als einmalige Pakete verkauft. Zahlungen werden sicher über Lemon Squeezy abgewickelt, das als eingetragener Händler (Merchant of Record) agiert; deine Kartendaten werden nie auf unseren Servern gespeichert. Da es kein wiederkehrendes Abonnement gibt, gibt es auch nichts zu kündigen. Gekaufte Credits verfallen nicht. Rückerstattungsanfragen bearbeitet Lemon Squeezy als Merchant of Record nach den eigenen Bedingungen; du kannst uns auch über unsere Support-Adresse erreichen.',
