const en = {
  ...
  imagePdf: {
    ...
    body: 'The file was saved as an image. If we cannot read it, the ATS at the company you apply to cannot either; your CV reaches them as a blank page.',
    fixesTitle: 'How to fix it',
    fixWord: 'In Word or Google Docs: File → Download → PDF.',
    fixCanva: 'In Canva: download as PDF Standard and leave "Flatten PDF" unticked.',
    fixPhoto: 'Only have a photo or a scan? Upload it to Google Drive, right-click → Open with → Google Docs. It is converted to text; check it and download it as a PDF.',
    check: 'Test it yourself: open the PDF and press Ctrl+A (Cmd+A on a Mac). If the text does not highlight, an ATS cannot read it.',
    uploadOther: 'Upload a different file',
    signupHint: 'Once you have a text-based PDF, create a free account; your first full report is on us.',
    signupCta: 'Create a free account',
    refunded: 'The credits spent on this upload have been refunded.',
  },
  ...
  legal: {
    ...
    terms: {
      ...
      s6Heading: '6. Pricing and Credits',
      s6Body1: 'CVision runs on credits; there is no recurring subscription. Every new account is granted free credits, and further free credits are added weekly while the balance stays below a set limit. Actions such as an analysis, a job-description match or a generated cover letter deduct credits from your balance; the current cost of each is published on the pricing page.',
      s6Body2: 'Additional credits are sold as one-off packs. Payments are processed securely through Lemon Squeezy, acting as merchant of record; your card details are never stored on our servers. As there is no recurring subscription, there is nothing to cancel. Purchased credits do not expire. Refund requests are handled by Lemon Squeezy as merchant of record under its own terms; you can also reach us at our support address.',
